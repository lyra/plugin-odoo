...
class AcquirerLyragw(models.Model):
    ...
    lyragw_redirect_enabled = fields.Selection(string=_('Redirection enabled'), help=_('If enabled, the buyer is automatically redirected to your site at the end of the payment.'), selection=[('0', _('Disabled')), ('1', _('Enabled'))])
