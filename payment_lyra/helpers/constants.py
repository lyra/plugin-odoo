...
LYRA_PAYMENT_DATA_ENTRY_MODE = {
    'redirect': 'Bank data acquisition on payment gateway',
    'smartform': 'Embedded Smartform on merchant site (REST API)',
    'smartform_extended_with_logos': 'Embedded Smartform extended on merchant site with logos (REST API)',
    'smartform_extended_without_logos': 'Embedded Smartform extended on merchant site without logos (REST API)'
}
